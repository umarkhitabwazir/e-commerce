  ...
  return (
    (
      ...
      product.map((products: ProductInterface) => (
        <div key={products._id} className={`rounded-lg bg-transparent  w-auto max-w-md p-6  mt-9 flex flex-wrap flex-col justify-center   md:flex-row items-center gap-6`}>
          {/* Product Image */}
