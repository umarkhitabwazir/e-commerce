                  ...
                  <div className="lg:col-span-1">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="font-medium text-gray-400">{order.userId.username}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Email</p>
                        <p className="font-medium text-gray-400">{order.userId.email}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Phone</p>
                        <p className="font-medium text-gray-400">{order.userId.phone}</p>
                      </div>
                      <div>
