...
const ShippingComponent = () => {
  ...
  const handleProceedPay = async () => {
    ...
    setLoading(false)
    router.push(`/payment-cashier?query=${btoa(JSON.stringify({productIdsAndQtyArr: [{ productId: decoded.productId, quantity: decoded.quantity }], price: decoded.price }))}`)
  }
  return (
    <>
      <div className=" bg-transparent h-full  grid grid-row-2  w-full p-6">
